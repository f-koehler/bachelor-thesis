...
# j=1
T, h, U, M = np.loadtxt("many/heating_J1.txt", unpack=True)
U = U/N
...
# j=2
T, h, U, M = np.loadtxt("many/heating_J2.txt", unpack=True)
U = U/N
Tval = np.linspace(T.min(), T.max(), 10000)
...
plt.legend(loc=4)
plt.grid()
plt.savefig("many_heating_J.pdf")
plt.close()
...
# j=1
T, h, U, M = np.loadtxt("many/cooling_J1.txt", unpack=True)
U = U/N
Tval = np.linspace(T.min(), T.max(), 10000)
plt.plot(T, U, label="$J=1$ (MC)")
plt.plot(Tval, theory.energy(Tval, 1.0), label="$J=1$ (theory)")
...
# j=2
T, h, U, M = np.loadtxt("many/cooling_J2.txt", unpack=True)
U = U/N
Tval = np.linspace(T.min(), T.max(), 10000)
plt.plot(T, U, label="$J=2$ (MC)")
plt.plot(Tval, theory.energy(Tval, 2.0), label="$J=2$ (theory)")
...
plt.legend(loc=4)
plt.grid()
plt.savefig("many_cooling_J.pdf")
plt.close()
...
# j=1
T, h, U, M = np.loadtxt("many/heating_h1.txt", unpack=True)
U = U/N
Tval = np.linspace(T.min(), T.max(), 10000)
...
# j=2
T, h, U, M = np.loadtxt("many/heating_h2.txt", unpack=True)
U = U/N
Tval = np.linspace(T.min(), T.max(), 10000)
...
plt.legend(loc=4)
plt.grid()
plt.savefig("many_heating_h.pdf")
plt.close()
...
# j=1
T, h, U, M = np.loadtxt("many/cooling_h1.txt", unpack=True)
U = U/N
Tval = np.linspace(T.min(), T.max(), 10000)
plt.plot(T, U, label="$h=1$ (MC)")
plt.plot(Tval, theory.energy(Tval, 1.0), label="$h=1$ (theory)")
...
# j=2
T, h, U, M = np.loadtxt("many/cooling_h2.txt", unpack=True)
U = U/N
Tval = np.linspace(T.min(), T.max(), 10000)
plt.plot(T, U, label="$h=2$ (MC)")
plt.plot(Tval, theory.energy(Tval, 2.0), label="$h=2$ (theory)")
...
plt.legend(loc=4)
plt.grid()
plt.savefig("many_cooling_h.pdf")
plt.close()
...
T, h, U, M = np.loadtxt("many/cooling.txt", unpack=True)
U = U/N
Tval = np.linspace(T.min(), T.max(), 10000)
...
# T=0
T, h, U, M = np.loadtxt("many/mag_T0.txt", unpack=True)
M = M/N
hval = np.linspace(h.min(), h.max(), 10000)
plt.plot(h, M, label="T=0 (MC)")

# T=1
T, h, U, M = np.loadtxt("many/mag_T1.txt", unpack=True)
M = M/N
hval = np.linspace(h.min(), h.max(), 10000)
...
# T=2
T, h, U, M = np.loadtxt("many/mag_T2.txt", unpack=True)
M = M/N
hval = np.linspace(h.min(), h.max(), 10000)
...
# J=0
T, h, U, M = np.loadtxt("many/mag_J0.txt", unpack=True)
M = M/N
hval = np.linspace(h.min(), h.max(), 10000)
...
# J=1
T, h, U, M = np.loadtxt("many/mag_J1.txt", unpack=True)
M = M/N
hval = np.linspace(h.min(), h.max(), 10000)
...
# J=2
T, h, U, M = np.loadtxt("many/mag_J2.txt", unpack=True)
M = M/N
hval = np.linspace(h.min(), h.max(), 10000)
