...
for i in range(0, numbers.shape[0]):
    _run, _success, _time, _steps = np.loadtxt("data/runtime2/data/"+str(i)+".txt", unpack=True)
...
np.savetxt("data/runtime2/results.txt", np.c_[n, success, successError, time, timeError, steps, stepsError], fmt="%4f")
