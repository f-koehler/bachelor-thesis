...
\begin{align*}
		...
		\Rightarrow a+b&=n+1
\end{align*}
Bei der Multiplikation $A\cdot B =N$ gilt also $a+b=n\:\vee\:a+b=n+1$. Mit Hilfe dieser Gleichung kann der Parameterbereich deutlich genauer eingegrenzt werden. Zunächst kann eine untere Schranke für $a$ gewonnen werden, es gilt:
\begin{equation*}
		a=n-b \:\vee\: a=n-b+1
\end{equation*}
...
\begin{figure}[ht]
		\centering
		\includegraphics[height=0.3\textheight]{plot/runtime-theo/runtime.pdf}
\end{figure}
\begin{figure}[ht]
		\centering
		\includegraphics[height=0.3\textheight]{plot/runtime-theo/comparison.pdf}
\end{figure}
