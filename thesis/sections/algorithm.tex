...
Im folgenden sollen zunächst einige Eigenschaften der binären Representation der Zahlen $A$ und $B$ abgeleitet werden.
...
Die Gleichungen~\eqref{eq:runtime-theo} und~\eqref{eq:runtime-theo-opt} wurden numerisch ausgewertet und in Abb.~\ref{fig:runtime-theo} graphisch dargestellt. Außerdem wurde die Abweichung
\begin{equation*}
